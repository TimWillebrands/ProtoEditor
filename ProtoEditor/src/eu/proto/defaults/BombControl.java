 ...
 * @author normenhansen
 */
public final class BombControl extends RigidBodyControl implements PhysicsCollisionListener, PhysicsTickListener {
    ...
    private void prepareEffect(AssetManager assetManager) {
        ...
        effect.setEndColor(new ColorRGBA(.65f, .22f, .12f, 0f));
